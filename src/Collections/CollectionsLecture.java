...
//        Collections.sort(numbers); // modifies original arraylist
...
//
        ...
        ArrayList<String> namesPrac = new ArrayList<>(Arrays.asList("Justin", "Douglas", "Kenneth"));
        LinkedList<String> namesPrac2 = new LinkedList<>(Arrays.asList("Justin", "Douglas", "Kenneth"));
        printEachElement(namesPrac);
        printEachElement(namesPrac2);
        /*
...
//        String str2 = (String) unsafe.get(0); // can lead to runtime exceptions
    ...
    peers.put("Darius", "Darius Brown");
    peers.put("Samuel", "Samuel Moore");
    peers.put("Felicia", "Felicia Davis");
        System.out.println(peers);

    Map<String, ArrayList<String> > peerArray = new HashMap<>();
    peerArray.put("Darius", new ArrayList<>(Arrays.asList("San Antonio", "Student Developer")) );
        System.out.println(peerArray.get("Darius"));
