...
public class ArraysLec_handout {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("prices = " + prices[1]);
        ...
        System.out.println("sidesArray = " + sidesArray);
        ...
        System.out.println("groceryList = " + groceryList[0]);
        System.out.println("diceSides = " + sidesArray[0]);
        ...
        System.out.println("Hello " + cohorts[0] + " students!");
        ...
        String[] taft = {"Gabbi", "Kathleen", "Itzel", "Mechelle"};

        System.out.println("taft = " + taft[0]);
        //~*~ Iterating Arrays ~*~
        //for + .length:

        //TODO Together: A for loop [for(init;cond;count){}] can perform similar iteration tasks as we had used it for in JS.
        for(int i = 0; i < taft.length; i++){
            System.out.println("My friends name's are, " + taft[i]);
        }
        //enhanced for (loop : loops){}
        //TODO Together: Java also provides an enhanced for [for (ele : arr) {}] to use!
        System.out.println();
        for(String names : taft){
            System.out.println("My best friends are " + names);
        }
        ...
        //the for loop lets you set the amount of runs ".length"
        //~*~ Java array.methods() ~*~
        ...
        System.out.println(Arrays.toString(cohorts).replace("[","").replace("]",""));
